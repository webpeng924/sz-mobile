<template>
  <div class="data">
    ...
    <div class="data_cell_case p10">
      ...
      <vue-cell v-for="(item,index) in payList"
                :key="index">
        <template #cellLeft>
          <div class="cell_left">
    ...
    <div class="data_cell_case">
      ...
      <div class="data_time_select m20">
        ...
        <div class="select select_right"
             @click="timeDown"
             :class="{active:upTime}">
          <i class="iconfont iconfanhui-right"></i>
        </div>
      </div>
      <vue-cell v-for="(item,index) in rankList"
                :key="index"
                class="rank_bgc">
        <template #cellLeft>
          <div class="cell_left">
    ...
    submit() {
      switch (this.type) {
        ...
        case 'select':
          ...
          let downLackTime = +this.currentDate - +MINDATE
          if (upLackTime > 0) {
            this.upTime = false
          }
          if (upLackTime <= 0) {
